...
*/
Udata Sender::nick_well_message(struct user sender, std::string new_nick) // 1st done
{
	Udata	ret;
...
*/
Udata Sender::quit_channel_message(struct user sender, std::string leave_message) // 1st done
{
	Udata	ret;
...
Udata Sender::quit_lobby_message(struct user sender, std::string leave_message) // 1st done
{
	Udata	ret;
...
/*
 ...
 @param user 유저네임
*/
Udata Sender::join_message(struct user sender, std::string channel) // 1st->done
{
	Udata	ret;
...
Udata Sender::part_message(struct user sender, std::string channel) // 1st donw
{
	Udata	ret;
...
Udata Sender::kick_message(struct user sender, std::string kicker, std::string subject, std::string channel) // 1st done
{
	Udata	ret;
...
Udata Sender::kick_error_not_op_message(struct user sender, std::string kicker, std::string channel) // 1st done
{
	Udata	ret;
...
Udata Sender::kick_error_no_user_message(struct user sender, std::string kicker, std::string subject, std::string channel)
{
	Udata	ret;
